...
from msg_push import (
    dingtalk, xizhi, tg_bot, send_email, bark, ntfy, pushplus, feishu
)
...
def push_message(record_name: str, live_url: str, content: str) -> None:
    ...
    push_functions = {
        ...
        '飞书': lambda: feishu(feishu_api_url, content),
...
while True:
    ...
    feishu_api_url = read_config_value(config, '推送配置', '飞书推送接口链接', "")
